...
#ifndef PHYSICS_RENDERER_SPHERE_TPP
#define PHYSICS_RENDERER_SPHERE_TPP
...
namespace phyren {
    namespace object {
        ...
        class Sphere : public Aggregate<n, T>{
        public:
            /**
             * Generate a new sphere object.
             */
            Sphere() : Aggregate<n, T>(ModelLoader::getInstance().getModel(PreModelType::SPHERE)){}
            /**
             * Draw this sphere to the screen
             *
...
#endif //PHYSICS_RENDERER_SPHERE_TPP
